...
public class PCEntityTypeTagsProvider extends EntityTypeTagsProvider {
	...
	@Override
	public void addTags() {
		this.tag(PCEntityTypeTags.COLLAR_DROP_MOBS).add(EntityType.WOLF, EntityType.CAT, EntityType.PARROT, PCEntityTypes.ZOMBIE_WOLF.get(), PCEntityTypes.ZOMBIE_CAT.get(), PCEntityTypes.ZOMBIE_PARROT.get());
	}
}